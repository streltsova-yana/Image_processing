...
int main(int argc, char** argv)
{
	...
	/////************Test Gaussian Noise************///
	Mat resimg_noise(A);
	cvtColor(resimg_noise, resimg_noise, COLOR_BGR2GRAY);
	imshow("do", resimg_noise);

	resimg_noise = Gaussian_noise(resimg_noise);
	imshow("Gaussian_noise", resimg_noise);
	...
	//cvtColor(resimg_gray2, resimg_gray2, COLOR_BGR2GRAY);
